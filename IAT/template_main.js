	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Nationalist', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Liberal', //Will appear in the data and in the default feedback message.
				title : {
			...
			// debriefingTextBottom : '<span> style="font-size: 8px";\n \n Este resultado no es una evaluación definitiva de tus actitudes. Presiona la barra de espacio para continuar.<span>', //Will be shown below the feedback text. 
